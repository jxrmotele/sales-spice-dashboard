...
// Webinar Script Framework — shown inside task 3-2 "Prepare your live event content"
...
export default function WebinarScript({ offerDetails }) {
  ...
  return (
    <div style={styles.wrapper}>
      <div style={styles.header}>
        <div>
          <div style={styles.headerLabel}>✦ Webinar Script Framework</div>
